...
export const useMainVehicleStore = defineStore('main-vehicle', () => {
   ...
   * @param {boolean} disableSlideToConfirm If true, the slide to confirm dialog will not be shown
   * @returns {Promise<void>}
   */
  async function arm(disableSlideToConfirm: boolean = false): Promise<void> {
   ...
   * @returns {Promise<void>}
   */
  async function disarm( disableSlideToConfirm: boolean = false ): Promise<void> {
    if (!mainVehicle.value) {
